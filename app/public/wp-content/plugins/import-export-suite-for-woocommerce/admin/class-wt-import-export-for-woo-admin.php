		...
		if ( Wt_Import_Export_For_Woo_Common_Helper::wt_is_screen_allowed() ) {
			...
			$params = array(
				...
				'pro_plugins' => array(
					...
					'product_tags'       => array(
						'sample_csv_url' => 'https://www.webtoffee.com/wp-content/uploads/2023/04/Sample_Product_tags.csv',
					),
					'product_categories' => array(
						'sample_csv_url' => 'https://www.webtoffee.com/wp-content/uploads/2023/04/Sample_Product_categories.csv',
					),
					'user'               => array(
	...
	public static function envelope_settings_tabcontent( $target_id, $view_file = '', $html = '', $variables = array(), $need_submit_btn = 0 ) {
		...
		<div class="wt-iew-tab-content" data-id="<?php echo esc_html( $target_id ); ?>">
			...
			if ( '' !== $view_file && file_exists( $view_file ) ) {
				// Trusted view paths are passed from plugin code (not user input).
				// nosemgrep.
