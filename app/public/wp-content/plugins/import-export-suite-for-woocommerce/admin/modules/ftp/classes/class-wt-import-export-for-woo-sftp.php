...
/**
 * SFTP vendor is now integrated with in the plugin.
 * you can safely remove the vendor file from the previous location if you have downloaded the add-on.
 * previous location : /wp-content/wt-sftp-vendor
 *
 * @since 1.3.3
 */
