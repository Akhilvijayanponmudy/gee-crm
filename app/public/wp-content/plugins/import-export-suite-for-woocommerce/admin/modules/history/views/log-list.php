...
<div class="wt_iew_history_page">
	...
	if ( is_array( $log_files ) && count( $log_files ) > 0 ) {
		...
		<?php if ( 0 === Wt_Import_Export_For_Woo_Common_Helper::get_advanced_settings( 'enable_import_log' ) ) : ?>        
			<span> <?php esc_html_e( 'Please enable import log under', 'import-export-suite-for-woocommerce' ); ?> <a target="_blank" href="<?php echo esc_url( admin_url( 'admin.php?page=wt_import_export_for_woo' ) ) . '&tab=settings'; ?>"><?php esc_html_e( 'settings', 'import-export-suite-for-woocommerce' ); ?></a></span>        
		<?php endif; ?>
		</h4>
		<?php
	}//end if
