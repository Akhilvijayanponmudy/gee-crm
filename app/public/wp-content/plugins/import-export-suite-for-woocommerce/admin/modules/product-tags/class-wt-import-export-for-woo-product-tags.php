<?php
/**
 * Handles the product tags import and export.
 *
 * @package   ImportExportSuite\Admin\Modules\ProductTags
 * @version   1.0.0
 */
...
/**
 * Wt_Import_Export_For_Woo_Product_Tags Class.
 */
class Wt_Import_Export_For_Woo_Product_Tags {
	...
	public function __construct() {
		...
		add_action( 'wt_tags_addon_help_content', array( $this, 'wt_tags_import_export_help_content' ) );
	}//end __construct()
	...
	public function importer_steps( $steps, $base ) {
		if ( $this->module_base === $base ) {
			$steps['advanced']['description'] = __( 'Use options from below to decide updates to existing tags, batch import count or schedule an import. You can also save the template file for future imports.' );
		}
		return $steps;
	}//end importer_steps()
	 ...
	 * @param string  $method_import Method import.
	...
	public function importer_do_import( $import_data, $base, $step, $form_data, $selected_template_data, $method_import, $batch_offset, $is_last_batch ) {
		...
		include plugin_dir_path( __FILE__ ) . 'import/class-wt-import-export-for-woo-product-tags-import.php';
		$import = new Wt_Import_Export_For_Woo_Product_Tags_Import( $this );
	...
	public function exporter_do_export( $export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset ) {
		...
		include plugin_dir_path( __FILE__ ) . 'export/class-wt-import-export-for-woo-product-tags-export.php';
		$export = new Wt_Import_Export_For_Woo_Product_Tags_Export( $this );
	...
	/**
	 * Set export columns for quick export
	 *
	 * @param array $form_data Form data.
	 */
	...
	public static function get_product_review_statuses() {
		...
		/**
		 * Filter the allowed product review statuses
		 *
	...
	/**
	 * Get tags sort columns
	 *
	 * @return array
	 */
	public static function get_tags_sort_columns() {
		$sort_columns = array(
			'id'   => __( 'Tag ID', 'import-export-suite-for-woocommerce' ),
			'name' => __( 'Tag name', 'import-export-suite-for-woocommerce' ),
			'slug' => __( 'Tag slug', 'import-export-suite-for-woocommerce' ),
		);

		/**
		 * Filter the allowed tags sort columns
		 *
	...
	}//end get_tags_sort_columns()

	/**
	 * Get tags post columns
	 *
	 * @return array
	 */
	...
	public function wt_get_product_tags() {
		...
		return $this->product_taxonomies;
	}//end wt_get_product_tags()

	/**
	 * Importer alter mapping fields
	 *
	 * @param array  $fields Fields.
	 * @param string $base Base.
	 * @param array  $step_page_form_data Step page form data.
	...
	public function wt_get_found_product_tag_meta() {
		...
		return $this->found_product_tag_meta;
	}//end wt_get_found_product_tag_meta()
	...
	/**
	 * Importer alter advanced fields
	 *
	 * @param array  $fields Fields.
	 * @param string $base Base.
	 * @param array  $advanced_form_data Advanced form data.
	 ...
	 */
	public function wt_tags_import_export_help_content() {
		if ( defined( 'WT_IEW_PLUGIN_ID' ) ) {
			?>
			<li>
				<img src="<?php echo esc_url( WT_IEW_PLUGIN_URL ); ?>assets/images/sample-csv.png">
				<h3><?php esc_html_e( 'Sample Product Tags CSV', 'your-text-domain' ); ?></h3>
				<p><?php esc_html_e( 'Familiarize yourself with the sample CSV.', 'your-text-domain' ); ?></p>
				<a target="_blank" href="<?php echo esc_url( 'https://www.webtoffee.com/wp-content/uploads/2023/04/Sample_Product_tags.csv' ); ?>" class="button button-primary">
					<?php esc_html_e( 'Get Product tags CSV', 'your-text-domain' ); ?>
				</a>
			</li>
			<?php
		}
	}//end wt_tags_import_export_help_content()
}
