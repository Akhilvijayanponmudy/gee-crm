	...
	<div style="float:right;">
		<div style="float:right;">
			...
			foreach ( $this->step_btns as $btnk => $btnv ) {
				...
				if ( 'button' === $btnv['type'] ) {
					?>
			<button class="button <?php echo esc_html( $button_standard_class ); ?> wt_iew_export_action_btn <?php echo esc_html( $css_class ); ?>" data-action-type="<?php echo esc_html( $action_type ); ?>" data-action="<?php echo esc_html( $btnv['key'] ); ?>" type="submit">
					...
					foreach ( $btn_arr as $btnkk => $btnvv ) {
						...
						?>
							<li class="wt_iew_export_action_btn" data-action-type="<?php echo esc_html( $action_type ); ?>"  data-action="<?php echo esc_html( $btnvv['key'] ); ?>" <?php echo esc_html( $field_attr ); ?> ><?php echo wp_kses_post( $btnvv['text'] ); ?></li>
								<?php
					}
					?>
					</ul>
					...
					?>
					<button style="display:none;" class="button button-primary wt_iew_export_action_btn <?php echo esc_html( $css_class ); ?>" data-action-type="<?php echo esc_html( $action_type ); ?>" data-action="<?php echo esc_html( $btnv['key'] ); ?>" type="submit">
					<?php echo wp_kses_post( $btnv['text'] ); ?>            
					</button>
					<?php
