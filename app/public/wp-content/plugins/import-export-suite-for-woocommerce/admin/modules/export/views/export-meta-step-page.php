...
?>
<table class="wt-iew-mapping-tb wt-iew-exporter-meta-mapping-tb" data-field-type="<?php echo esc_html( $meta_mapping_screen_field_key ); ?>">
	<thead>
		<tr>
			<th>
				<?php
				$is_checked_value = isset( $meta_mapping_screen_field_val['checked'] ) ? (int) $meta_mapping_screen_field_val['checked'] : 0;
				?>
				<input type="checkbox" name="" class="wt_iew_mapping_checkbox_main" <?php checked( $is_checked_value, 1 ); ?>>
			</th>
